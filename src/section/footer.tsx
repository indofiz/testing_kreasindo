        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-3">
              ...
              <span className="text-xl font-bold text-white">Malinau Data</span>
            </div>
            <p className="text-sm">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              <li>24/7 Support: +1 (555) 123-4567</li>
              <li>Sales: sales@malinaudata.com</li>
              <li>Press: press@malinaudata.com</li>
        ...
        <div className="border-t border-slate-800 mt-12 pt-8 text-center md:text-left">
          <div className="md:flex items-center justify-between">
            <p className="text-sm text-gray-400">
              © {new Date().getFullYear()} Malinau Data. All rights reserved.
            </p>
